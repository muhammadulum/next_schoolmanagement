...
import BigCalender from '@/components/BigCallender'
        ...
        <div className='flex-1 p-4 flex flex-col xl:flex-row gap-4'>
            ...
            <div className='w-full xl:w-2/3'>
                ...
                <div className='flex flex-col lg:flex-row gap-4'>
                    {/* User Info Card */}
                    <div className='bg-lamaSky py-5 px-4 rounded-md flex-1 flex gap-4'>
                        <div className='w-1/3'>
                            <Image
                    ...
                    <div className='flex-1 flex gap-4 justify-between flex-wrap'>
                        ...
                        <div className='w-full  bg-white rounded-md flex gap-4 md:w-[48%] xl:w-[45%] 2xl:w-[48%] '>
                            ...
                            <div className=''>
                                ...
                                <span className='text-sm text-gray-400'>Leasson</span>
                            </div>
                        </div>
            ...
            <div className='w-full xl:w-1/3 flex flex-col gap-4'>
                ...
                <div className='bg-white p-4 rounded-md'>
                    ...
                    <div className='mt-4 flex gap-4 flex-wrap text-xs text-gray-500'>
                        ...
                        <Link className='p-3 rounded-md bg-lamaSkyLight' href="/">Student&apos;s Students</Link>
